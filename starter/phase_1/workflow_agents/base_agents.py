...
class KnowledgeAugmentedPromptAgent:
    ...
    def respond(self, input_text):
        """Generate a response using the OpenAI API."""
        system_prompt = f"""you are {self.persona} knowledge-based assistant. 
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        """
        This method takes a user prompt and extracts the steps required to complete the action described in the prompt, based on the agent's knowledge."""
